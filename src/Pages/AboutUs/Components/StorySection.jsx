          ...
          <div className="flex">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-medium leading-tight">
                To simplify financial transactions and compliance, so businesses
                can focus on what truly matters — growth.
              </h1>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start lg:items-center">
            <div className="w-full lg:w-1/2 shadow-2xl rounded-xl overflow-hidden">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src =
                    "https://placehold.co/800x600/6b21a8/ffffff?text=Image+Unavailable";
                }}
              />
            </div>
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-4 text-base font-normal text-gray-300 leading-relaxed">
                <p>
                  What started as a shared vision between two professionals — CA
                  Devan Gupta and CA Kapil Mahani — has grown into a trusted
                  advisory firm driven by integrity, precision, and innovation.
                </p>
                <p>
                  Under their leadership, Cretum Advisory has built long-term
                  relationships with clients by combining deep industry
                  expertise with hands-on collaboration.
                </p>
                <p>
                  With a diverse team of CAs, lawyers, and financial experts, we
                  provide tailored solutions that adapt to the ever-changing
