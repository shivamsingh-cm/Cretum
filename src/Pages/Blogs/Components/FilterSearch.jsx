...
const FilterSearch = ({ currentPage: propCurrentPage, onPageChange }) => {
  ...
  const handleClearAllFilters = () => {
    ...
    setCheckedCategories(
      Object.keys(checkedCategories).reduce(
  ...
  const handleCategoryChange = (category) => {
    setCheckedCategories((prev) => {
      ...
      const newActiveFilters = Object.keys(newChecked).filter(
        (key) => newChecked[key]
      );
      setActiveFilters(newActiveFilters);
  ...
  const showNoResultsMessage =
    displayedPosts.length === 0 && (isSearchActive || activeFilters.length > 0);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          ...
          <aside className="lg:col-span-4 xl:col-span-3 flex flex-col gap-8">
            ...
            <form
              ...
              className="flex flex-col sm:flex-row rounded-lg overflow-hidden border border-purple-700/50 focus-within:ring-2 focus-within:ring-purple-500"
            >
              <input
                type="text"
                id="search-blogs"
            ...
            <div>
              <span className="text-base font-normal text-gray-100 mb-4 block">
                Category
              </span>
              <div
                ...
                {availableCategories.map((category) => (
                  <div key={category} className="flex items-center">
                    ...
                    <label
                      ...
                      className="ml-3 text-sm font-normal text-gray-200 cursor-pointer"
                    >
                      {category}
                    </label>
                  </div>
