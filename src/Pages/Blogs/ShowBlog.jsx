...
const ShowBlog = () => {
  ...
  const tags = getTags();
   ...
   console.log("my seo data from in show blog post  ===================", seo)
  ...
  return (
    <div className="min-h-screen bg-backgroundPrimary text-white font-sans pt-16">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content={seo?.metaDescription || blogPost?.summary || 'Read our latest insights.'}
        />
        <meta name="keywords" content={seo.keyword || ''} />

        {/* open graph for social sharing */}
        <meta property="og:title" content={seo.metaTitle || blogPost?.title} />
        <meta property="og:description" content={seo.metaDescription || blogPost?.summary} />
        <meta property="og:image" content={blogPost?.imageUrl || RandomImage} />
        <meta property="og:type" content="article" />

        {/* twitter card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={seo.metaTitle || blogPost?.title} />
        <meta name="twitter:description" content={seo.metaDescription || blogPost?.summary} />
        <meta name="twitter:image" content={blogPost?.imageUrl || RandomImage} />
      </Helmet>
      <img 
        src={BlogHeading} 
        alt="Blog Heading" 
