...
//       salary: "₹4L - ₹8L PA",
//       description:
//         "Join our Tax Technology vertical as a Full Stack Developer to build innovative solutions that transform GST refund processes for businesses across India.",
...
//       salary: "₹4L - ₹8L PA",
//       description:
//         "We are looking for an experienced Frontend Developer to join our team and help build amazing user experiences for our financial products.",
...
//       salary: "₹4L - ₹8L PA",
//       description:
//         "Create amazing user experiences and beautiful interfaces that delight our customers in the financial advisory space.",
...
//               {filteredJobs.length}
//             </span>{" "}
//             of <span className="text-white font-semibold">{jobs.length}</span>{" "}
//             positions
...
//             <div
//               key={job.id}
//               className={`rounded-xl p-6 cursor-pointer transition-all duration-300 group border border-white/10 flex flex-col h-full ${
//                 hoveredCard === job.id
  ...
  return (
    <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="container mx-auto max-w-7xl">
        {/* Header Section */}
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 bg-blue-50 rounded-full px-4 py-2 border border-blue-200 mb-6">
          ...
          <div className="max-w-2xl mx-auto mb-6">
            <div className="relative">
              <input
                ...
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full px-6 py-4 rounded-xl bg-gray-50 border border-gray-300 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
              {searchTerm && (
                <button
                  onClick={clearSearch}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredJobs?.map((job) => (
            <div
              key={job.id}
              className={`rounded-xl p-6 cursor-pointer transition-all duration-300 group border border-gray-200 flex flex-col h-full ${
                hoveredCard === job.id
                  ? "shadow-xl transform -translate-y-1 bg-blue-50 border-blue-200"
              ...
              <div className="flex-grow">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {job?.tags?.map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1 text-xs rounded-full bg-gray-100 text-gray-700 border border-gray-300"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className="mt-auto">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 pt-4 border-t border-gray-200">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">Annual package</p>
                  </div>
                  <button
                    onClick={() => handleMoreInfo(job.id)}
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <div className="flex gap-3 justify-center flex-wrap">
                ...
                <button
                  onClick={() => setSelectedCategory("All")}
                  className="px-6 py-3 rounded-lg font-semibold text-gray-700 border border-gray-300 hover:bg-gray-100 transition-colors"
                >
                  View All Categories
                </button>
              </div>
        ...
        {/* Footer CTA */}
        <div className="text-center mt-12 sm:mt-16 border-t border-gray-200 pt-12">
          <p className="text-gray-600 mb-4">
            Can't find what you're looking for?
          </p>
          <button
            onClick={onContactClick}
            className="px-8 py-4 rounded-lg font-semibold text-blue-600 border-2 border-blue-600 hover:bg-blue-600 hover:text-white transition-all duration-300"
          >
            Submit Your Resume
          </button>
        </div>
