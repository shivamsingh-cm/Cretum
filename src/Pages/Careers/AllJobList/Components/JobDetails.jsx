    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="text-center max-w-md w-full">
          ...
          <button
            onClick={() => navigate("/career/all-job-list")}
            className="px-6 py-3 bg-purple-400 hover:bg-purple-600 text-white rounded-lg transition-colors duration-300 w-full sm:w-auto"
          >
            Back to Careers
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-white py-8 sm:py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-gray-600 hover:text-gray-800 mb-6 sm:mb-8 transition-colors duration-300 group mt-4 sm:mt-6"
        >
        ...
        {/* Job Header */}
        <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8 shadow-sm border border-gray-200">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
            <div className="flex-1 w-full">
              ...
              <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-4 text-gray-600 mb-4">
                <div className="flex items-center gap-2">
                  <span>🏢</span>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 mb-6">
                <span className="px-3 py-1.5 sm:px-4 sm:py-2 bg-purple-400 text-white rounded-full text-xs sm:text-sm font-semibold">
                  {job.type}
                </span>
                <span className="px-3 py-1.5 sm:px-4 sm:py-2 bg-purple-100 text-purple-800 rounded-full text-xs sm:text-sm font-semibold">
                  {job.employmentType}
                </span>
                <span className="px-3 py-1.5 sm:px-4 sm:py-2 bg-blue-100 text-purple-600 rounded-full text-xs sm:text-sm font-semibold">
                  {job.experience} Experience
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row lg:flex-col gap-3 w-full sm:w-auto lg:w-48">
              <button
                onClick={handleApplyNow}
                className="px-6 py-2 sm:px-8 sm:py-2 bg-buttonBackground hover:bg-buttonBackgroundHover text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105 active:scale-95 shadow-sm text-sm sm:text-base"
              >
                Apply Now
              </button>
              <button className="px-6 py-2 sm:px-8 sm:py-2 border-2 border-buttonBackground text-buttonBackground hover:bg-buttonBackgroundHover hover:text-white font-semibold rounded-lg transition-all duration-300 text-sm sm:text-base">
                Save Job
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-2 mt-6">
            {job?.tags?.map((tag, index) => (
              <span
                key={index}
                className="px-3 py-1.5 bg-white text-gray-700 rounded-full text-xs sm:text-sm font-medium border border-gray-300"
              >
                {tag}
              </span>
            ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            {/* Company Description */}
            <section className="bg-gray-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-200">
          ...
          <div className="space-y-6">
            {/* Quick Apply */}
            <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-6 border border-gray-200 sticky top-6">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">
                Quick Apply
              </h3>
              <button
                onClick={handleApplyNow}
                className="w-full py-2 sm:py-2 bg-buttonBackground hover:bg-buttonBackgroundHover text-white font-semibold rounded-lg transition-colors duration-300 mb-3 text-sm sm:text-base"
              >
                Apply Now
              </button>
              <button className="w-full py-2 sm:py-2 border-2 border-buttonBackground text-buttonBackground hover:bg-buttonBackgroundHover hover:text-white font-semibold rounded-lg transition-colors duration-300 text-sm sm:text-base">
                Save for Later
              </button>
              ...
              <div className="mt-6 p-4 bg-white rounded-lg border border-gray-300">
                ...
                <a
                  href={`mailto:${job.contactEmail}`}
                  className="text-blue-600 hover:text-blue-700 font-medium break-all text-sm sm:text-base"
                >
                  {job.contactEmail}
                </a>
              </div>
            ...
            {/* Job Overview */}
            <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-6 border border-gray-200">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">
                Job Overview
              </h3>
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900 font-medium text-sm sm:text-base text-right max-w-[60%]">
                    {job.title}
                  </span>
                </div>
                <div className="flex justify-between">
        ...
        {/* Application Process */}
        <section className="bg-gray-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 mt-6 sm:mt-8 border border-gray-200">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">
            Application Process
          </h2>
          <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
        ...
        {/* Apply Form Modal */}
        {showApplyForm && <ApplyForm job={job} onClose={handleCloseForm} />}
      </div>
    </div>
  );
};
