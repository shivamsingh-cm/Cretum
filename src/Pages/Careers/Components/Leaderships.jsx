      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-10">
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-start">
          <img
            ...
            alt="Leadership Team"
            loading="lazy"
            className="w-full max-w-md md:max-w-none h-96 object-cover  rounded-lg shadow-lg border border-gray-400"
          />
        </div>

        {/* Right: Text Content take 50%  */}
        <div className="w-full md:w-1/2 text-gray-900 space-y-4">
          <h6 className="text-[#A164FF] text-base font-medium">
            Meet Our Leadership
          </h6>
          ...
          <div className="space-y-[24px]">
            <p className="text-sm sm:text-base md:text-base font-normal text-gray-600 leading-[150%]">
              At Cretum Advisory, leadership isn't just about titles — it's
              about setting direction, inspiring people, and creating
              opportunities for growth. Our leadership team brings together deep
              industry expertise, entrepreneurial thinking, and a shared
              commitment to building a future where businesses don't just adapt,
              but thrive.
            </p>
          </div>
        </div>
