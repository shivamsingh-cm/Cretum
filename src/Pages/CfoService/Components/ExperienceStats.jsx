...
const ExperienceStats = () => {
  const stats = [
    {
      number: "20-30",
      label: "Improvement in Cash Flow Visibility",
      suffix: "%",
    },
    { number: 40, label: "Client Satisfaction Rate", suffix: "%" },
    { number: 50, label: "Companies Using Our CFO Systems", suffix: "+" },
    { number: 99, label: "Accuracy in MIS & Financial Reporting", suffix: "%" },
  ];
