...
import BackgroundImage from "../../../assets/SlidersCarousels.png";
...
const Services = () => {
  ...
  return (
    <section className="bg-backgroundPrimary text-white p-7 overflow-hidden relative">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Optional: Add overlay if needed for better text readability */}
        <div className="absolute inset-0 bg-backgroundPrimary/80"></div>
      </div>

      {/* Content - everything remains exactly the same */}
      <div className="relative z-10 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 md:gap-32 lg:gap-56 items-center">
