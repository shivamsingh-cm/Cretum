...
// const IncomeTaxHero = () => {
//   return (
//     <section className="relative w-full min-h-screen flex items-center py-16 px-4 md:px-12 lg:px-20  overflow-hidden">
...
//             End-to-End Income Tax Solutions for <br />
//             Companies and Startups
//           </h1>

//           {/* Description */}
//           <p className="text-gray-300 max-w-xl mb-8 text-sm md:text-lg">
//             One place for everything — ITR filing, notices, assessments,
//             representation, TDS, and tax optimization.
//           </p>
