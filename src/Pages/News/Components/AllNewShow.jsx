...
//           setInitialized(true); // Still set to true to use mock data
//         }
//       }
//     };
...
//   useEffect(() => {
//     if (initialized) {
//       const data = newsApi.getPaginatedNews(currentPage, articlesPerPage);
//       setNewsData(data);
//       setLoading(false);
//     }
...
//               {[1, 2].map(i => (
//                 <div key={i} className="bg-backgroundSecondary rounded-2xl h-48"></div>
//               ))}
//             </div>
//           </div>
//         </div>
...
//                 <div key={article.id} className="bg-backgroundSecondary border border-backgroundSecondary rounded-2xl shadow-md flex flex-col md:flex-row h-auto md:h-62 overflow-hidden">
...
const AllNewsShow = ({ currentPage: propCurrentPage, onPageChange }) => {
  ...
  useEffect(() => {
    if (initialized) {
      const data = newsApi.getPaginatedNews(internalCurrentPage, articlesPerPage);
      setNewsData(data);
      setLoading(false);
    }
