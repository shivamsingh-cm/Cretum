  ...
  const stats = [
    {
      number: "20-30",
      label:
        "Faster clarity in business setup, compliance, and founder decision-making",
      suffix: "%",
    },
    {
      number: 40,
      label: "Startup registration, documentation, and compliance workflows",
      suffix: "%",
    },
    {
      number: 50,
      label: "Startups trust our consulting and growth advisory",
      suffix: "+",
    },
    {
      number: 99,
