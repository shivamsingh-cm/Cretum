...
export default function TermsOfUse() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 p-4 sm:p-6 md:p-10 lg:p-16">
      <header className="max-w-7xl mx-auto mb-6 sm:mb-8 animate-fadeIn mt-6 sm:mt-10">
        <div className="bg-gradient-to-r from-gray-50 to-[#A164FF]/10 text-gray-800 rounded-2xl p-6 sm:p-8 shadow-lg border border-[#A164FF]/20">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">
            Terms of Use
          </h1>
          <p className="mt-2 sm:mt-3 text-sm sm:text-base text-gray-600 max-w-3xl leading-relaxed">
            These Terms of Use govern your access to and use of Cretum
            Advisory's website. By continuing to browse or use our site, you
            agree to these terms.
          </p>
      ...
      <main className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-10">
        {/* Table of contents */}
        <aside className="lg:col-span-3 order-2 lg:order-1 animate-slideInLeft">
          <nav
            aria-label="Table of contents"
            className="sticky top-6 bg-gray-50/80 backdrop-blur-md border border-[#A164FF] rounded-xl p-4 sm:p-5 shadow-sm"
          >
            ...
            <ul className="space-y-2">
              {sections.map((s) => (
                <li key={s.id}>
                  <a
                    href={`#${s.id}`}
                    className="block text-sm text-gray-600 hover:text-[#A164FF] transition-all duration-200 hover:translate-x-1"
                  >
                    {s.title}
                  </a>
                </li>
        ...
        {/* Content area */}
        <article className="lg:col-span-6 order-1 lg:order-2 bg-white rounded-2xl p-4 sm:p-6 md:p-8 shadow-md border border-gray-200 animate-fadeInUp">
              ...
              <section key={s.id} id={s.id} className="scroll-mt-24">
                ...
                {s.id === "contact-information" && (
                  <p className="mt-3 sm:mt-4">
                    <a
                      href="mailto:info@cretumadvisory.com"
                      className="text-[#A164FF] hover:text-[#8B3EFF] transition-colors underline text-sm sm:text-base"
                    >
                      info@cretumadvisory.com
                    </a>
                  </p>
          ...
          <div className="mt-8 sm:mt-10 border-t border-gray-200 pt-4 sm:pt-6 text-sm text-gray-500">
            <p>
              Please read these terms carefully. If you do not agree with any
              part of these terms, you must stop using the Website.
            </p>
        ...
        {/* Right column */}
        <aside className="lg:col-span-3 order-3 animate-slideInRight">
          <div className="bg-white rounded-2xl border border-[#A164FF] p-4 sm:p-5 shadow-md sticky top-6">
            ...
            <div className="mt-4 sm:mt-5">
              <Link
                to="/contact-us"
                className="inline-block bg-[#A164FF] text-white px-3 py-2 rounded-lg hover:bg-[#8B3EFF] transition-colors text-sm sm:text-base"
              >
                Contact Us
              </Link>
            </div>
      ...
      <div className="max-w-6xl mx-auto mt-12 sm:mt-16">
        <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 sm:p-8 md:p-12 border border-[#A164FF]/20 relative overflow-hidden">
          {/* Animated Background Elements */}
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -top-20 -left-20 w-60 h-60 bg-[#A164FF] rounded-full opacity-5 blur-3xl animate-pulse-slow"></div>
            <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-[#8B3EFF] rounded-full opacity-5 blur-3xl animate-pulse-slow animation-delay-2000"></div>

            {/* Floating Particles */}
            {[...Array(8)].map((_, i) => (
              <div
                key={i}
                className="absolute w-2 h-2 bg-[#A164FF] rounded-full opacity-10 animate-float"
                style={{
                  left: `${10 + i * 12}%`,
                  top: `${20 + i * 8}%`,
                  animationDelay: `${i * 0.7}s`,
          ...
          <div className="relative z-10">
            <div className="text-center mb-8 sm:mb-10">
              <div className="flex items-center justify-center gap-3 mb-3 sm:mb-4">
                <div className="p-2 sm:p-3 bg-[#A164FF]/10 rounded-2xl">
                  <Bell className="w-6 h-6 sm:w-8 sm:h-8 text-[#A164FF] animate-bounce animation-delay-1000" />
                </div>
              ...
              <p className="text-lg sm:text-xl text-gray-700 mb-2 sm:mb-3 font-semibold">
                JOIN OUR EXCLUSIVE NEWSLETTER
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-10">
              {newsletterBenefits.map((benefit, index) => (
                <div
                  key={index}
                  className="bg-white rounded-xl p-4 sm:p-5 border border-gray-200 hover:border-[#A164FF] transition-all duration-300 hover:transform hover:scale-105 group shadow-sm"
                >
                  <div className="flex items-center gap-3 mb-2 sm:mb-3">
                    <div className="p-2 bg-[#A164FF]/10 rounded-lg group-hover:bg-[#A164FF]/20 transition-colors">
                      <benefit.icon className="w-4 h-4 sm:w-5 sm:h-5 text-[#A164FF]" />
                    </div>
            ...
            {/* CTA Section */}
            <div className="bg-white rounded-2xl p-6 sm:p-8 border border-[#A164FF]/20 shadow-sm">
              <div className="flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8">
                ...
                <button
                  onClick={openModal}
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-[#A164FF] to-[#8B3EFF] text-white rounded-xl font-semibold hover:from-[#8B3EFF] hover:to-[#7A2BFF] transform transition-all duration-300 hover:scale-105 flex items-center gap-2 sm:gap-3 group shadow-lg hover:shadow-xl min-w-[160px] sm:min-w-[200px] justify-center text-sm sm:text-base"
                >
              ...
              {/* Trust Indicators */}
              <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-xs sm:text-sm text-gray-500">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
          <div className="relative max-w-md w-full animate-scaleIn">
            {/* Modal Content */}
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl border border-[#A164FF] shadow-2xl overflow-hidden">
              {/* Header */}
              <div className="relative p-4 sm:p-6 border-b border-gray-200">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-[#A164FF]/10 rounded-lg">
                    <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 text-[#A164FF]" />
                  </div>
                  <div>
                ...
                <button
                  onClick={closeModal}
                  className="absolute top-3 sm:top-4 right-3 sm:right-4 p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-all duration-200"
                >
              ...
              <div className="p-4 sm:p-6">
                {isSubscribed ? (
                  <div className="text-center py-6 sm:py-8 animate-fadeIn">
                    ...
                    <div className="w-10 h-1 sm:w-12 bg-gradient-to-r from-[#A164FF] to-[#8B3EFF] rounded-full mx-auto"></div>
                  </div>
                ) : (
                  <form
                  ...
                  >
                    <div className="space-y-3 sm:space-y-4">
                      ...
                      <div className="group">
                        <label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-2">
                          <User className="w-3 h-3 sm:w-4 sm:h-4 text-[#A164FF]" />
                          Full Name
                        </label>
                        <input
                          type="text"
                          ...
                          onChange={(e) => setName(e.target.value)}
                          placeholder="Enter your full name"
                          className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-white border border-gray-300 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:border-[#A164FF] focus:ring-2 focus:ring-[#A164FF]/20 transition-all duration-300 text-sm sm:text-base"
                          required
                        />
                      </div>
                      ...
                      <div className="group">
                        <label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-2">
                          <Mail className="w-3 h-3 sm:w-4 sm:h-4 text-[#A164FF]" />
                          Email Address
                        </label>
                        <input
                          type="email"
                    ...
                    <div className="bg-gray-50 rounded-xl p-3 sm:p-4 border border-gray-200">
                      <div className="flex items-start gap-2 sm:gap-3">
                        <Shield className="w-3 h-3 sm:w-4 sm:h-4 text-green-500 mt-0.5 flex-shrink-0" />
