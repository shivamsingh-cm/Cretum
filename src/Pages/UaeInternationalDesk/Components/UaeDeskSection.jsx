...
//     },
//     {
//       icon: <FaClipboardCheck className="text-4xl text-purple-400" />,
//       title: "Audit & Internal Controls",
//     },
//     {
//       icon: <FaLifeRing className="text-4xl text-purple-400" />,
//       title: "Ongoing Support",
//     },
//   ];

//   return (
//     <section className="bg-[#120d24] text-white py-16 px-6 md:px-12 lg:px-24">
//       <div className="max-w-7xl mx-auto text-center   p-8 md:p-12">
...
//               <div className="bg-purple-900/30 p-5 rounded-full">{item.icon}</div>
//               <p className="text-sm md:text-base text-gray-200">{item.title}</p>
//             </div>
//           ))}
//         </div>
//       </div>
...
const UaeDeskSection = () => {
  ...
  return (
    <section className="bg-[#120d24] text-white py-16 px-6 md:px-12 lg:px-24 relative overflow-hidden">
          ...
          {features.map((item, index) => (
            <div key={index} className="flex flex-col items-center text-center space-y-4 relative">
              ...
              {/* {index < features.length - 1 && (
                <svg
                  className="hidden md:block absolute top-0 left-[65%] w-36 h-16"
                  viewBox="0 0 50 50"
                  fill="none"
